    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="flex gap-4 mt-6">
        <button
          onClick={query}
          disabled={loading}
          className={`bg-blue-600 text-white font-semibold py-2 px-6 rounded-lg shadow hover:bg-blue-700 transition ${loading ? 'opacity-60 cursor-not-allowed' : ''
            }`}
        >
          {loading ? '查詢中…' : '查詢'}
        </button>
        ...
        {results.map((r, i) => (
          ...
          >
            ...
            <div className="text-center">
              ...
              <div
                className={`text-lg font-semibold ${r.prize && r.prize !== '查無中獎紀錄'
                  ? 'text-green-700'
                  : 'text-red-600'
                  }`}
              >
